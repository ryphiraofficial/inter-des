import POInventory from '../../models/procurement/POInventory.js';

export const getPOInventoryItems = async (req, res) => {
    try {
...
export const getPOInventoryItem = async (req, res) => {
    try {
...
export const createPOInventoryItem = async (req, res) => {
    try {
...
export const updatePOInventoryItem = async (req, res) => {
    try {
...
export const deletePOInventoryItem = async (req, res) => {
    try {
        const item = await POInventory.findById(req.params.id);
        if (!item) {
            return res.status(404).json({ success: false, message: 'Item not found' });
