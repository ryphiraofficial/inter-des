...
const OverviewStats = ({ loading, stats }) => {
    ...
    const items = [
        { title: "Total Revenue", value: formatCurrency(stats?.paidAmount), subValue: "vs last month", icon: IndianRupee, trend: stats?.trends?.revenue, color: "#10b981", bg: "#dcfce7" },
        { title: "Total Expenses", value: formatCurrency(stats?.totalExpenses), subValue: "vs last month", icon: Wallet, trend: stats?.trends?.expenses, color: "#467dcfff", bg: "#dbeafe" },
