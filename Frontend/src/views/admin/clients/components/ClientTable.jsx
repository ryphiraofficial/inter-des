                                ...
                                >
                                    ...
                                    <td className="desktop-hide">
                                        <div className="c-action-buttons">
                                            ...
                                            <button className="btn-icon-delete" onClick={(e) => { e.stopPropagation(); handleDelete(client); }} title="Delete"><Trash2 size={16} /></button>
                                        </div>
                                    </td>
                                        ...
                                        <td colSpan="3">
                                            <div className="expansion-content">
                                                ...
                                                <div className="expansion-actions">
                                                    ...
                                                    <button className="btn-mobile-action danger" onClick={() => handleDelete(client)}><Trash2 size={16} /> Delete Client</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
